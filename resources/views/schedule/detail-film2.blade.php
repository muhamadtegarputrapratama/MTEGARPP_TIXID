    ...
    <div class="w-75 d-block m-auto">
        <div class="d-flex">
            <div style="width: 150px; height: 200px">
                <img src= "https://i.pinimg.com/736x/94/b3/6a/94b36ab42e1a6aa416efdcb098f71509.jpg" class="w-100">
            </div>
            <div class="ms-5 mt-4">
                <h5>Rampage</h5>
                <table>
                    <tr>
                        ...
                        <td class="px-3"></td>
                        <td>Petualangan, Laga, Monster, Bencana,</td>
                    </tr>
                    <tr>
                        <td><b class="text-secondary">Durasi</b></td>
                        <td class="px-3"></td>
                        <td>1 Jam 47 Menit</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="px-3"></td>
                        <td><span class="badge badge-warning">13</span>
                    </tr>
                </table>
            </div>
        </div>
